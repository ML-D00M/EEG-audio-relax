...
# 1st condition
theta_16sub_1=readMat('theta_16sub_cond_1.mat')$theta.sub
theta_16sub_1=as.vector(theta_16sub_1)
# 2nd condition
theta_16sub_2=readMat('theta_16sub_cond_2.mat')$theta.sub
theta_16sub_2=as.vector(theta_16sub_2)
# 3rd condition
theta_16sub_3=readMat('theta_16sub_cond_3.mat')$theta.sub
theta_16sub_3=as.vector(theta_16sub_3)

## 2 group - Control/Sea (10 subjects)
# 1st condition
theta_10Csub_1=readMat('theta_10Csub_cond_1.mat')$theta.sub 
theta_10Csub_1=as.vector(theta_10Csub_1)
# 2nd condition
theta_10Csub_2=readMat('theta_10Csub_cond_2.mat')$theta.sub
theta_10Csub_2=as.vector(theta_10Csub_2)
# 3rd condition
theta_10Csub_3=readMat('theta_10Csub_cond_3.mat')$theta.sub
theta_10Csub_3=as.vector(theta_10Csub_3)
...
c1_Before <- c(theta_16sub_1, theta_10Csub_1)
c2_During <- c(theta_16sub_2, theta_10Csub_2)
c3_After <- c(theta_16sub_3, theta_10Csub_3)

df_theta_16_10 <- data.frame(id, group, c1_Before, c2_During, c3_After)

# Gather the columns c1_Before and c2_After into long format.
# Convert id and cond into factor variables
df_theta_16_10 <- df_theta_16_10 %>%
...
df_theta_16_10$score <- df_theta_16_10$score*1e13

# Inspect some random rows of the data by groups
set.seed(123)
df_theta_16_10 %>% sample_n_by(group, cond, size = 1)
...
#sum.table <- summary(df_theta_16_10)
...
#df_theta_16_10 <- df_theta_16_10[-c(8,18,34,44), ]
# to Remove all the outliers
#tbr=which(df_theta_16_10$score%in%out$score)
#df_theta_16_10=df_theta_16_10[-tbr,]
...
ggqqplot(df_theta_16_10, "score", ggtheme = theme_bw()) +
...
res.aov <- anova_test(
  data = df_theta_16_10, dv = score, wid = id,
...
library(nparLD)
np_anova_model<-nparLD(score ~ cond * group, data = df_theta_16_10,
...
# on the Theta score in each Group

# One-Way Anova - simple main effect of Cond variable
one.way2 <- df_theta_16_10 %>%
  group_by(group) %>%
...
ggbarplot(df_theta_16_10, x = "cond", y = "score", 
          ylab='mean Theta score', fill='group',
          add = c("mean_se"),
...
# on the Theta score in each ??ondition

# One-Way Anova - simple main effect of the Group variable
one.way <- df_theta_16_10 %>%
  group_by(cond) %>%
...
# Bar-plot for 2 grouping variables
ggbarplot(df_theta_16_10, x = "group", y = "score", 
          ylab='mean Theta score', fill='cond',
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
# Bar-plot for 2 grouping variables
ggbarplot(df_theta_16_10, x = "cond", y = "score", 
          ylab='median Theta score', fill='group',
          add = c("median"),
          #error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
# Bar-plot for 2 grouping variables
ggbarplot(df_theta_16_10, x = "group", y = "score", 
          ylab='median Theta score', fill='cond',
          add = c("median"),
          #error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
ggbarplot(df_theta_16_10, x = "group", y = "score", 
  ...
  stat_pvalue_manual(Wlx.test, label = "p = {p}", 
                     y.position = 5, # put 25 if geom_jitter
                     tip.length = 0.03, size=3,
                     step.increase = 0.2)+
  labs( # add labels
    title = "?????????????????? Theta-????????????????????",
...
c1_Before_Hypno <- c(theta_16sub_1)
c2_During_Hypno <- c(theta_16sub_2)
c3_After_Hypno <- c(theta_16sub_3)
c1_Before_Ctrl <- c(theta_10Csub_1)
c2_During_Ctrl <- c(theta_10Csub_2)
c3_After_Ctrl <- c(theta_10Csub_3)
...
# Data preparation
df_theta_16_10_g1 <- data.frame(idg1, c1_Before_Hypno, c2_During_Hypno, c3_After_Hypno) # create df
df_theta_16_10_g1 <- df_theta_16_10_g1 %>% # convert df
  gather(key = "cond", value = "score", c1_Before_Hypno, c2_During_Hypno, c3_After_Hypno) %>%
  convert_as_factor(idg1, cond)
#df_theta_16_10_g1 <- df_theta_16_10_g1[-c(18), ] # remove outlier-18
df_theta_16_10_g1$score <- df_theta_16_10_g1$score*1e13 # normalization
...
ggqqplot(df_theta_16_10_g1, x = "score", facet.by = "cond")
# Check the equality of variances
df_theta_16_10_g1 %>% levene_test(score ~ cond) # p should be >0.05
...
ttest.g1 <- df_theta_16_10_g1 %>% 
  t_test(score ~ cond, paired = TRUE) %>%
  add_significance()
ttest.g1

# Effect size
df_theta_16_10_g1 %>% cohens_d(score ~ cond, paired = TRUE, var.equal = FALSE)
...
ggbarplot(df_theta_16_10_g1, x = "cond", y = "score", 
          ylab='mean Theta score', fill=cond.colors_hyp,
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
ggpaired(df_theta_16_10_g1, x = "cond", y = "score", 
...
# Kruskal-Wallis test 1
one.way.np.g1 <- df_theta_16_10_g1 %>%
  kruskal_test(score ~ cond)
one.way.np.g1
...
# Effect size
df_theta_16_10_g1 %>% wilcox_effsize(score ~ cond)

# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_g1, x = "cond", y = "score", 
          ylab='median Theta score', fill=cond.colors_hyp,
          add = c("median"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
  ...
  stat_pvalue_manual(Wlx.test.g1, label = "p = {p}", 
                     y.position = 5, # put 15 if geom_jitter
                     tip.length = 0.03, size=3,
                     step.increase = 0.2)+
  labs( # add labels
    title = "?????????????????? Theta-????????????????????",
...
# Data preparation
df_theta_16_10_g2 <- data.frame(idg2, c1_Before_Ctrl, c2_During_Ctrl, c3_After_Ctrl) # create df
df_theta_16_10_g2 <- df_theta_16_10_g2 %>% # convert df
  gather(key = "cond", value = "score", c1_Before_Ctrl, c2_During_Ctrl, c3_After_Ctrl) %>%
  convert_as_factor(idg2, cond)
#df_theta_16_10_g1 <- df_theta_16_10_g1[-c(18), ] # remove outlier-18
df_theta_16_10_g2$score <- df_theta_16_10_g2$score*1e13 # normalization
...
df_theta_16_10_g2 %>%
  ...
  shapiro_test(score)
# Draw a qq plot by cond
ggqqplot(df_theta_16_10_g2, x = "score", facet.by = "cond")
# Check the equality of variances
df_theta_16_10_g2 %>% levene_test(score ~ cond) # p should be >0.05
...
# Compute Weltch T-test, which is the safer one
ttest.g2 <- df_theta_16_10_g2 %>% 
  t_test(score ~ cond, paired = TRUE) %>%
  add_significance()
ttest.g2

# Effect size
df_theta_16_10_g2 %>% cohens_d(score ~ cond, paired = TRUE, var.equal = FALSE)

# Report
# Auto-compute p-value label positions
ttest.g2 = ttest.g2 %>% add_xy_position(x = "cond")
# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_g2, x = "cond", y = "score", 
          ylab='mean Theta score', fill=cond.colors_ctrl,
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  geom_jitter(size=1, width=0.1)+ # add subjects
...
# Visualization for paired samples
ggpaired(df_theta_16_10_g2, x = "cond", y = "score", 
...
# Kruskal-Wallis test 2
one.way.np.g2 <- df_theta_16_10_g2 %>%
  kruskal_test(score ~ cond)
one.way.np.g2

# Effect size of the Cond on Theta score in Group 2
df_theta_16_10_g2 %>%
  kruskal_effsize(score ~ cond)

# Wilcoxon test
Wlx.test.g2 <- df_theta_16_10_g2 %>% 
  wilcox_test(score ~ cond, paired = TRUE,
              p.adjust.method = "BH") %>%
  add_significance()
Wlx.test.g2
...
# Effect size
df_theta_16_10_g2 %>% wilcox_effsize(score ~ cond)

# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_g2, x = "cond", y = "score", 
          ylab='median Theta score', fill=cond.colors_ctrl,
          add = c("median"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
df_theta_16_10_c1 <- data.frame(id, group, c1_Before) # create df
names(df_theta_16_10_c1)[names(df_theta_16_10_c1) == 
                           'c1_Before'] <- 'score'
#df_theta_16_10_c1 <- df_theta_16_10_c1[-c(18), ] # remove outlier-18
df_theta_16_10_c1$score <- df_theta_16_10_c1$score*1e13 # normalization
...
ggqqplot(df_theta_16_10_c1, x = "score", facet.by = "group")
# Check the equality of variances
df_theta_16_10_c1 %>% levene_test(score ~ group) # p should be >0.05
...
# Compute Weltch T-test, which is the safer one
ttest.c1 <- df_theta_16_10_c1 %>% 
  t_test(score ~ group, paired = FALSE) %>%
  add_significance()
ttest.c1

# Effect size
df_theta_16_10_c1 %>% cohens_d(score ~ group, var.equal = FALSE)
...
# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_c1, x = "group", y = "score", 
          ylab='mean Theta score',
          fill = group.colors,
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
...
# Effect size
df_theta_16_10_c1 %>% wilcox_effsize(score ~ group)

# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_c1, x = "group", y = "score", 
          ylab='median Theta score', fill=group.colors,
          add = c("median"),
          #error.plot = 'upper_errorbar',
          position = position_dodge(width=0.8))+
  #geom_jitter(size=1, width=0.1)+ # add subjects
...
df_theta_16_10_c2 <- data.frame(id, group, c2_During) # create df
names(df_theta_16_10_c2)[names(df_theta_16_10_c2) == 
                           'c2_During'] <- 'score'
#df_theta_16_10_c2 <- df_theta_16_10_c2[-c(18), ] # remove outlier-18
df_theta_16_10_c2$score <- df_theta_16_10_c2$score*1e13 # normalization
...
df_theta_16_10_c2 %>%
  ...
  shapiro_test(score)
# Draw a qq plot by group
ggqqplot(df_theta_16_10_c2, x = "score", facet.by = "group")
# Check the equality of variances
df_theta_16_10_c2 %>% levene_test(score ~ group) # p should be >0.05
...
# Compute Weltch T-test, which is the safer one
ttest.c2 <- df_theta_16_10_c2 %>% 
  t_test(score ~ group, paired = FALSE) %>%
  add_significance()
ttest.c2

# Effect size
df_theta_16_10_c2 %>% cohens_d(score ~ group, var.equal = FALSE)

# Report
# Auto-compute p-value label positions
ttest.c2 = ttest.c2 %>% add_xy_position(x = "group")
# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_c2, x = "group", y = "score", 
          ylab='mean Theta score',
          fill = group.colors,
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
...
# Effect size
df_theta_16_10_c2 %>% wilcox_effsize(score ~ group)
...
df_theta_16_10_c3 <- data.frame(id, group, c3_After) # create df
names(df_theta_16_10_c3)[names(df_theta_16_10_c3) == 
                           'c3_After'] <- 'score'
#df_theta_16_10_c3 <- df_theta_16_10_c3[-c(18), ] # remove outlier-18
df_theta_16_10_c3$score <- df_theta_16_10_c3$score*1e13 # normalization
...
df_theta_16_10_c3 %>%
  ...
  shapiro_test(score)
# Draw a qq plot by group
ggqqplot(df_theta_16_10_c3, x = "score", facet.by = "group")
# Check the equality of variances
df_theta_16_10_c3 %>% levene_test(score ~ group) # p should be >0.05
...
# Compute Weltch T-test, which is the safer one
ttest.c3 <- df_theta_16_10_c3 %>% 
  t_test(score ~ group, paired = FALSE) %>%
  add_significance()
ttest.c3

# Effect size
df_theta_16_10_c3 %>% cohens_d(score ~ group, var.equal = FALSE)
...
# Bar-plot for 1 grouping variable
ggbarplot(df_theta_16_10_c3, x = "group", y = "score", 
          ylab='mean Theta score',
          fill = group.colors,
          add = c("mean_se"),
          error.plot = 'upper_errorbar',
...
# Effect size
df_theta_16_10_c3 %>% wilcox_effsize(score ~ group)
